...
class MpClientAgent(CommonBase):
    ...
    agent_ver   = Column(String(10), nullable=False, info='Agent Version', doc=60)
    version     = Column(String(10), info='App Version', doc=61)
    build       = Column(String(10), info='Build', doc=62)
    pkg_name    = Column(String(100), nullable=False, info='PKG Name', doc=99)
    pkg_url     = Column(String(255), info='PKG URL', doc=99)
    pkg_hash    = Column(String(50), info='PKG Hash(SHA1)', doc=99)
    active      = Column(Integer, nullable=False, server_default="0", info='Active', doc=99)
    state       = Column(Integer, nullable=False, server_default="0", info='State', doc=99)
    cdate       = Column(DateTime, server_default='1970-01-01 00:00:00', info='Create Date', doc=99)
    mdate       = Column(DateTime, server_default='1970-01-01 00:00:00', info='Modify Date', doc=99)
...
class MpClientAgentsFilter(CommonBase):
    ...
    attribute_filter    = Column(String(255), nullable=False, info='Filter Value')
